				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
                            <br><br><br><br>
							<div class="contact_info_title">Testimoni Form</div>
							<form action="#" class="comment_form">
								<div>
									<div class="form_title">Pesan</div>
									<input type="text" class="comment_input comment_textarea" required="required" name="pesan" id="pesan">
                                </div>
								<div>
